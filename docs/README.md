...
## My name is Bryan J. Rentoul (aka gruvin)
Crypto is full of theiving @#$!'ds. Do NOT trust ANY communication with or from
...
at my FlowCrypt™ **Encrypted Contact Page** (powered by GPG)

GitHub release tags should be GPG signed by myself. You can verify the code is how it was when I signed thusly ...

Retrieve my public key from from my [FlowCrypt™ Encrypted Contact Page](https://flowcrypt.com/me/gruvin)
